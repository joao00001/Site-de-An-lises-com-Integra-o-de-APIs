...
// Alterna o tema e salva no Local Storage
function toggleTheme() {
    const body = document.body;
    const themeToggle = document.getElementById('theme-toggle');

    // Alterna a classe 'dark-mode' no body e no botão
...
// Carrega o estado do tema do Local Storage ao inicializar a página
...
// Inicializa o tema e adiciona o evento ao botão
document.addEventListener('DOMContentLoaded', () => {
    initializeTheme(); // Carrega o tema salvo
